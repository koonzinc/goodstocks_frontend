...
import Image2 from "../../assets/isaiahpic.PNG";
      ...
      <div class="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6 ">
        ...
        <div class="grid gap-8 mb-6 lg:mb-16 md:grid-cols-2">
          ...
          <div class="items-center bg-gray-50 rounded-lg shadow sm:flex ">
            ...
            <div class="p-5">
              <h3 class="text-xl font-bold tracking-tight text-gray-900 ">
                <a href="#">Isaiah Desta</a>
              </h3>
              <span class="text-gray-500 ">Software Engineer</span>
              <p class="mt-3 mb-4 font-light text-gray-500 ">
                Isaiah Desta is a cofounder @ Goodstocks
              </p>
              <ul class="flex space-x-4 sm:mt-0">
                <li>
                  <a
                    href="https://github.com/areandd"
                    class="text-gray-500 hover:text-gray-900 "
                  >
                    <svg
                      class="w-5 h-5"
