    ...
    <div className="bg-white px-6 py-4 shadow-2xl rounded-lg flex flex-col col-span-2 ">
      ...
      <div className="bg-white shadow-lg rounded-lg px-4 py-6 mt-6">
        ...
        <div className="flex flex-col mt-4">
          ...
          <p className="text-gray-700 text-sm">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Et error excepturi earum dicta facilis numquam, quasi veritatis omnis totam aliquid! Laborum ad, odio ipsa nulla nostrum quod voluptatum fugit placeat.</p>
        </div>
      </div>
      {/* Posts container */}
      <div className="bg-white shadow-lg rounded-lg px-4 py-6 mt-6">
