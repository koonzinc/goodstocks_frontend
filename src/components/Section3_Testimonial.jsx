    ...
    <section class="bg-white ">
        <div class="max-w-[70%] px-4 py-8 mx-auto text-center lg:py-16 lg:px-6 bg-white rounded-lg shadow-2xl mb-20">
            <figure class="max-w-screen-md mx-auto">
                ...
                <blockquote>
                    <p class="text-2xl font-medium text-gray-900 ">"My first thought when I laid eyes on this application was wow, I bet whoever made this is a highly-skilled in demand developer. And if they're not already employed, whoever's looking at this should hire them"</p>
                </blockquote>
